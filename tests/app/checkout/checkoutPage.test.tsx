...
jest.mock('@3asoftwares/ui', () => ({
    ...
    ToasterBox: ({ message, type, show }: any) => (
        show ? <div data-testid="toaster" className={type}>{message}</div> : null
    ),
}));
...
describe('CheckoutPage', () => {
    ...
    describe('Shipping Address', () => {
        ...
        it('should render address section', () => {
            ...
            const pageText = document.body.textContent || '';
            expect(pageText.includes('Shipping') || pageText.includes('Address') || pageText.length > 0).toBe(true);
        });
    });
    ...
    describe('Delivery Method', () => {
        ...
        it('should render delivery section', () => {
            ...
            const pageText = document.body.textContent || '';
            expect(pageText.includes('Delivery') || pageText.includes('delivery') || pageText.includes('Shipping')).toBe(true);
        });
    });
