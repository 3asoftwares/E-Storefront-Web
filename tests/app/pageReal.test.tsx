...
jest.mock('../../store/cartStore', () => ({
    useCartStore: () => ({
        addItem: mockAddItem,
        recentlyViewed: [
            { productId: 'rv1', name: 'Recently Viewed 1', price: 19.99 },
        ],
        items: [],
        wishlist: [],
    }),
        ...
        mockUseProducts.mockReturnValue({
            data: {
                products: [
                    ...
                    { id: 'p2', name: 'Featured Product 2', price: 49.99, description: 'Another great product' },
                ],
            },
            isLoading: false,
            error: null,
        ...
        it('should show toast notification after adding to cart', () => {
            ...
            if (productCards.length > 0) {
                ...
                expect(mockShowToast).toHaveBeenCalledWith(
                    'Featured Product 1 added to cart!',
                    'success'
                );
            }
        });
