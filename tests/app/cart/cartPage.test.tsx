...
jest.mock('../../../components', () => ({
    PageHeader: ({ title, icon, badge }: any) => (
        <header data-testid="page-header">
            <h1>{title}</h1>
            {badge && <span data-testid="badge">{badge.count} {badge.label}</span>}
        </header>
    ),
...
describe('CartPage', () => {
    ...
    describe('Cart with Items', () => {
        const mockItems = [
            ...
            { id: 'item2', name: 'Test Product 2', price: 49.99, quantity: 1, image: 'https://example.com/image.jpg' },
        ];
        ...
        it('should show shipping information', () => {
            ...
            expect(pageText.includes('Shipping') || pageText.includes('shipping') || pageText.includes('Free')).toBe(true);
        });
    ...
    describe('Checkout Flow', () => {
        const mockItems = [
            { id: 'item1', name: 'Test Product', price: 29.99, quantity: 1 },
        ];
