...
jest.mock('@/components/CategoryModal', () => {
    return function MockCategoryModal({ isOpen, onClose, onSelect, categories, selectedCategory }: any) {
...
describe('ProductForm', () => {
    ...
    it('should render with initial data', () => {
        ...
        expect(screen.getByPlaceholderText('Enter product description')).toHaveValue('A test product description');
    ...
    it('should update form fields on input change', () => {
        ...
        fireEvent.change(descriptionInput, { target: { name: 'description', value: 'Product description' } });
    ...
    it('should clear selected category', async () => {
        ...
        const clearButton = clearButtons.find(button => button.textContent?.includes('close') || button.querySelector('[data-testid="icon"]'));
        ...
        await waitFor(() => {
            expect(screen.queryByText('Select a category...') || screen.queryByText('Electronics')).toBeTruthy();
        });
    });
