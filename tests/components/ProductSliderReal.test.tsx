...
describe('ProductSlider', () => {
  const mockChildren = [
    ...
    <div key="4" data-testid="slide-4">
      Product 4
    </div>,
    <div key="5" data-testid="slide-5">
      Product 5
    </div>,
    <div key="6" data-testid="slide-6">
      Product 6
    </div>,
    <div key="7" data-testid="slide-7">
      Product 7
    </div>,
    <div key="8" data-testid="slide-8">
      Product 8
    </div>,
  ];
  ...
  it('should not render navigation when all items fit in one slide', () => {
    const fewChildren = [<div key="1">Product 1</div>, <div key="2">Product 2</div>];
